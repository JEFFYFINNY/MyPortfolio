...
const Navbar = () => {
  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo>
          <NavLink href="/" style={{ display: 'flex', alignItems: 'center', color: 'white', marginBottom: '20px' }}>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <GitHubButton style={{ padding: '10px 16px', background: theme.primary, color: 'white' }} href={Bio.github} target="_blank">
              Github Profile
            </GitHubButton>
          </MobileMenu>
        )}
